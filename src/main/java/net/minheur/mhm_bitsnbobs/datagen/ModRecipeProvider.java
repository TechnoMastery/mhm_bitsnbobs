...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> pWriter) {
        ...
        CreateMixingRecipeBuilder.mix(HeatCondition.HEATED)
                .addIngredient(JsonBuilder.getSimpleItem(ModItems.CORNMEAL.get()))
                .addIngredient(JsonBuilder.getSimpleItem(OtherModItems.CreateFood.BUTTER.getAsRawItem()))
                ...
                .addResult(JsonBuilder.getSimpleItem(ModItems.POLENTA.get()))
