...
public class CreateFilingRecipeProvider {
    ...
    public static CreateFilingRecipeProvider fill() {
        return new CreateFilingRecipeProvider();
    }
     ...
     * @return the current recipe
     */
    public CreateFilingRecipeProvider addResult(ItemLike item) {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation id) {
        ...
        consumer.accept(new Result(id.withPrefix("create/filing/"), this.ingredients, this.results, this.advancement, id.withPrefix("recipes/create/filing/")));
    }
    /**
     * Saves the recipe
     * @param consumer the recipe consumer
