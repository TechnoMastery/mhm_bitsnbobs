...
import net.minheur.mhm_bitsnbobs.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    /// Dois être public, très important
    ...
    private void setupAnimationStates() {
        ...
        if (this.isAttacking() && attackAnimationTimeout <= 0) {
            attackAnimationTimeout = 80; // durée en ticks de l'animation
    ...
    /// Il s'agit des "goals" du mod : en gros son IA
    /// le premier nombre est la priorité : plus le nombre est petit, plus il sera executé tôt.
    /// Ci-dessous un exemple basique de goals : Float (pour pas couler xD), se reproduire, suivre une nourriture, etc.
    @Override
    ...
    // override sounds to chose them, can also add our own sounds
    @Override
